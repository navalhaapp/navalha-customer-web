...
class EvaluateBottonSheet extends StatefulWidget {
  const EvaluateBottonSheet({
    Key? key,
  ...
  @override
  State<EvaluateBottonSheet> createState() => _SelectServiceBottonSheetState();
}

class _SelectServiceBottonSheetState extends State<EvaluateBottonSheet> {
  String? description;
