...
class CardServiceSelected extends StatefulWidget {
  ...
  @override
  State<CardServiceSelected> createState() => _CardServiceSelectedState();
}

class _CardServiceSelectedState extends State<CardServiceSelected> {
  bool loading = false;
