...
class RegistrationSocialNetworks extends StatefulHookConsumerWidget {
  const RegistrationSocialNetworks({
    super.key,
    this.name,
    required this.email,
  ...
  @override
  ConsumerState<RegistrationSocialNetworks> createState() =>
      _RegistrationSocialNetworksState();
}
                      ...
                      case AuthCepState.loggedIn:
                        {
                          ...
                          await prefs.setString('password', widget.userId);
